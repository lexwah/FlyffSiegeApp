...
import { CrownFilled, StarFilled, VideoCameraOutlined } from '@ant-design/icons';
import './style.css';
...
const SiegeListItem = ({
  ...
  <Link to={`/siege/${siege.siegeId}`} className="sl-item">
    ...
    <div className="sl-item-right">
      ...
      <span className="sl-item-vods">
        <VideoCameraOutlined title="VODs" className="sl-item-icon vod" />
        {' '}
        <span className="sl-item-vods-val">{siege.vodCount || 0}</span>
      </span>
    </div>
  </Link>
);
